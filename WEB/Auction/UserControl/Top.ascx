<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Top.ascx.cs" Inherits="WEB.Auction.UserControl.Top" %>
 <div class="top">
           ...
           <asp:Panel ID="Panel2" runat="server" Visible="false">
                <div class="top_login">您好！&nbsp;<asp:HyperLink ID="hlnkUserName" runat="server"></asp:HyperLink>&nbsp;<a href="../UserInfo/Biding.aspx" target="_self">个人中心</a>&nbsp;<asp:LinkButton 
        ...
        <div>
            ...
            <div class="top_menu">
                <ul>
                    ...
                    <li><a href="../Auction/FreeAuctionList.aspx" target="_self">免费体验</a></li>
                    <li><a href="../Auction/PointsMall.aspx" target="_self">积分商城</a></li>
                    <li><a href="../Auction/ShowOrder.aspx" target="_self">拍客晒图</a></li>
                </ul>
            </div>
          </div>