<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Top.ascx.cs" Inherits="WEB.Auction.UserControl.Top" %>
 <div class="top">
            <asp:Panel ID="Panel1" runat="server">
                 <div class="top_login">欢迎来到拍拍网！&nbsp;<a href="#" target="_self">[登录]</a>&nbsp;<a href="" target="_self">[免费注册]</a></div>
            </asp:Panel>
           <asp:Panel ID="Panel2" runat="server" Visible="false">
                <div class="top_login">您好！&nbsp;<asp:HyperLink ID="hlnkUserName" runat="server"></asp:HyperLink>&nbsp;<a href="" target="_self">个人中心</a>&nbsp;<asp:LinkButton ID="lbtnLoginOut" runat="server" Text="安全退出"></asp:LinkButton></div>
           </asp:Panel>
